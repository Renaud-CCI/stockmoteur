<template>
  <section id="contact" class="py-20 bg-secondary text-neutral-50">
    <div class="max-w-3xl mx-auto px-6">
      ...
      <form class="space-y-6" action="https://formsubmit.co/334c083b8ef2f7504ad05661fc3f0029" method="POST">
